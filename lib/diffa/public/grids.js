...
Diffa.Trade.random = function () {
    ...
    return new this({id: kind + id_padding+ id})
}

Diffa.RandomDataSource = function(listener) {
    this._listener = listener;
}

Diffa.RandomDataSource.prototype.generate = function generate() {
    this._listener([new Diffa.Trade()]);
}
...
Diffa.BootstrapGrids = function() { 
    ...
    Diffa.tradeEntryView = new Diffa.GridView($("#grid_trade_entry"), null, tradeEntryColumns, options);
    Diffa.futuresRiskGrid = new Diffa.GridView($("#grid_futures_risk"), null, futuresRiskColumns, options);
    Diffa.optionsRiskGrid = new Diffa.GridView($("#grid_options_risk"), null, optionsRiskColumns, options);
};
